...
/**
 * 테스트 명   : TestCase_01_KOR_QEWRTY_PORT
...
public class TestCase_01_KOR_QEWRTY_PORT {
    String testType;
    //String runTime;
    StringBuffer word;
    Device device;
    ...
    public TestCase_01_KOR_QEWRTY_PORT(Device device, String testType) {
        this.device = device;
    ...
    private void ReadyTest() throws RemoteException, UiObjectNotFoundException {
        ...
        Qwerty_kor = new Qwerty(device, device.getContext(), KeyType.PORTRAIT, KeyType.KOR_QWERTY);
